...
exports.shipping = async (req, res, next) =>{
    try{
         const userinfomation = req.body.userInformation;
         const productinformation = req.body.productInformation;
         const totalprice = req.body.totalPrice;

         if(userinfomation == undefined || productinformation == undefined || totalprice == undefined){
             res.status(200).json({error : "Information Missing...."});
         }
